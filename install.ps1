...
function Get-DownloadUrl {
    # NSIS installer: NexusAI.Tools_4.1.31_x64-setup.exe
    $script:DownloadUrl = "https://github.com/$Repo/releases/download/v$($script:ReleaseVersion)/NexusAI.Tools_$($script:ReleaseVersion)_x64-setup.exe"
    $script:Filename = "NexusAI.Tools_$($script:ReleaseVersion)_x64-setup.exe"
