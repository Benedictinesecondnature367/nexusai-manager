...
const GITHUB_API_URL: &str = "https://api.github.com/repos/VisualLock/NexusAI-Manager/releases/latest";
const GITHUB_RAW_URL: &str = "https://raw.githubusercontent.com/VisualLock/NexusAI-Manager/main/package.json";
const JSDELIVR_URL: &str = "https://cdn.jsdelivr.net/gh/VisualLock/NexusAI-Manager@main/package.json";
...
const UPDATER_JSON_URL: &str = "https://github.com/VisualLock/NexusAI-Manager/releases/latest/download/updater.json";
...
async fn check_updater_json() -> Result<UpdateInfo, String> {
    ...
    let download_url = format!("https://github.com/VisualLock/NexusAI-Manager/releases/tag/v{}", latest_version);
...
async fn check_static_url(url: &str, source_name: &str) -> Result<UpdateInfo, String> {
    ...
    let download_url = "https://github.com/VisualLock/NexusAI-Manager/releases/latest".to_string();
...
pub fn is_homebrew_installed() -> bool {
    ...
    {
        let caskroom_paths = [
            "/opt/homebrew/Caskroom/nexusai-tools",
            "/usr/local/Caskroom/nexusai-tools",
        ];
...
/// Execute `brew upgrade --cask nexusai-tools` with timeout (macOS only)
...
#[cfg(target_os = "macos")]
pub async fn brew_upgrade_cask() -> Result<String, String> {
    logger::log_info("Starting Homebrew Cask upgrade for nexusai-tools...");
    ...
    let result = tokio::time::timeout(
        ...
        tokio::process::Command::new(brew_path)
            .args(["upgrade", "--cask", "nexusai-tools"])
            .output()
    ).await;
