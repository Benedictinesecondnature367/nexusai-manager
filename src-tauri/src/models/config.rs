...
pub struct AppConfig {
    ...
    pub nexusai_executable: Option<String>, // [NEW] Manually specified NexusAI executable path
    pub nexusai_args: Option<Vec<String>>, // [NEW] NexusAI startup arguments
    #[serde(default)]
