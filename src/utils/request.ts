...
const COMMAND_MAPPING: Record<string, { url: string; method: 'GET' | 'POST' | 'DELETE' | 'PATCH' }> = {
  ...
  'get_nexusai_path': { url: '/api/system/nexusai/path', method: 'GET' },
  'get_nexusai_args': { url: '/api/system/nexusai/args', method: 'GET' },
  ...
  'clear_nexusai_cache': { url: '/api/system/cache/clear', method: 'POST' },
  'get_nexusai_cache_paths': { url: '/api/system/cache/paths', method: 'GET' },
